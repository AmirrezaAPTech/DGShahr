...
const CommentsContainer = () => {
  ...
  return (
    ...
    <div className={`xl:grid xl:grid-cols-3 xl:w-[1156px] w-full flex max-xl:overflow-x-auto max-sm:pb-16 xl:gap-y-12 xl:gap-x-4 gap-12 ${commentsVisible ? "" : "xl:h-96 xl:overflow-hidden xl:bg-white xl:opacity-60"}`}>
